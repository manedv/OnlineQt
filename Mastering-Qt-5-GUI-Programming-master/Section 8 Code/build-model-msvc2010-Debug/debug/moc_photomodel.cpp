...
#include "../../1_qt_widgets/photomodel.h"
...
struct qt_meta_stringdata_PhotoModel_t {
    QByteArrayData data[1];
    char stringdata0[11];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_PhotoModel_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PhotoModel_t qt_meta_stringdata_PhotoModel = {
    {
QT_MOC_LITERAL(0, 0, 10) // "PhotoModel"
...
const QMetaObject PhotoModel::staticMetaObject = {
    { &QAbstractListModel::staticMetaObject, qt_meta_stringdata_PhotoModel.data,
      qt_meta_data_PhotoModel,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PhotoModel::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PhotoModel.stringdata0))
