...
#include "../../1_qt_widgets/colorpicker.h"
...
QT_MOC_LITERAL(1, 12, 9), // "new_color"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 3) // "val"

    },
    "ColorPicker\0new_color\0\0val"
};
...
void ColorPicker::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->new_color((*reinterpret_cast< QColor(*)>(_a[1]))); break;
        default: ;
        }
        ...
        void **func = reinterpret_cast<void **>(_a[1]);
        {
            ...
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ColorPicker::new_color)) {
                *result = 0;
            }
        }
    }
...
// SIGNAL 0
void ColorPicker::new_color(QColor _t1)
{
